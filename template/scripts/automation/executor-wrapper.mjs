...
import { DEFAULT_EXECUTOR_PROMPT_TEMPLATE, resolveExecutorPromptTemplate } from './lib/executor-policy.mjs';
...
async function main() {
  ...
  const promptTemplate = resolveExecutorPromptTemplate(executor.promptTemplate || DEFAULT_EXECUTOR_PROMPT_TEMPLATE);
